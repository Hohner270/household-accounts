...
fetch("/cardLogs", {
    ...
    var cardLogs = JSON.parse(json);
    var chartDataList = {
        payment: [],
        color: []

        // 店舗（カードを使用した場所）ごとに「支払い金額」の統計をとる
    };for (var index in cardLogs) {
        var usedPlace = cardLogs[index].usedPlace.trim();
    ...
    var pieChart = new __WEBPACK_IMPORTED_MODULE_0_chart_js___default.a(pieChartElement, {
        type: 'doughnut',
        data: chartData,
        options: {
            animation: {
